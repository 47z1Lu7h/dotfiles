# Generated by Powerlevel10k configuration wizard on 2023-04-14 at 18:04 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # 3asdf                    # asdf version manager (https://github.com/asdf-vm/asdf)
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE=' ^g^q     ^b'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='  ^h  '
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE=' ^z     ^b'
