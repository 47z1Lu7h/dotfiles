...
#   -------------------------------------------------------------------
    ii() {
        ...
        echo -e "\n\t${BIyellow}󰨕 ${blue}Users logged on:$NC${cyan}" ; w -h
        echo -e "\n\t${BIyellow}󰨕 ${blue}Current date:$NC${Icyan}" ; date
        echo -e "\n\t${BIyellow}󰨕 ${blue}Machine stats:$NC${Bcyan}" ; uptime 
        echo -e "\n\t${BIyellow}󰨕 ${blue} Current network location:$NC${BIcyan}" ; curl ipinfo.io
        echo -e "\n${end}"
    }
