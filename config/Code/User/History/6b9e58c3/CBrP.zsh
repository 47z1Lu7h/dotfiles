...
#   -------------------------------------------------------------------
    ii() {
        echo -e "\n\t${BIyellow}󰨕 ${blue}You are logged on ${BIpurple}$HOST"
        echo -e "\n\t${BIyellow}󰨕 ${blue}Additionnal information:$NC${yellow}" ; uname -a
        echo -e "\n\t${BIyellow}󰨕 ${blue}Users logged on:$NC${yellow}" ; w -h
        echo -e "\n\t${BIyellow}󰨕 ${blue}Current date:$NC${yellow}" ; date
        echo -e "\n\t${BIyellow}󰨕 ${blue}Machine stats:$NC${yellow}" ; uptime 
        echo -e "\n\t${BIyellow}󰨕 ${blue} Current network location:$NC${yellow}" ; curl ipinfo.io
        echo -e "\n${end}"
    }
