...
#   -------------------------------------------------------------------
    ii() {
        echo -e "\n\t${BIwhite}󰨕 ${Iyellow}You are logged on ${BIred}$HOST"
        echo -e "\n\t${BIwhite}󰨕 ${Iblue}Additionnal information:$NC " ; uname -a
        echo -e "\n\t${BIwhite}󰨕 ${Iyellow}Users logged on:$NC" ; w -h
        echo -e "\n\t${BIwhite}󰨕 ${Iblue}Current date:$NC" ; date
        echo -e "\n\t${BIwhite}󰨕 ${BIyellow}Machine stats:$NC" ; uptime 
        echo -e "\n\t${BIwhite}󰨕 ${Bblue}Current network location :$NC" ; curl ipinfo.io
        echo -e "\n${end}"
    }
