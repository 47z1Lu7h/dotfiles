...
#   -------------------------------------------------------------------
    ii() {
        ...
        echo -e "\n\t${BIyellow}󰨕 ${blue}Additionnal information:$NC${purple}" ; uname -a
        echo -e "\n\t${BIyellow}󰨕 ${blue}Users logged on:$NC${BIblack}" ; w -h
        echo -e "\n\t${BIyellow}󰨕 ${blue}Current date:$NC${blue}" ; date
        echo -e "\n\t${BIyellow}󰨕 ${blue}Machine stats:$NC${blue}" ; uptime 
        echo -e "\n\t${BIyellow}󰨕 ${blue} Current network location:$NC${blue}" ; curl ipinfo.io
        echo -e "\n${end}"
    }
