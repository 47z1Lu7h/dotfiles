...
#   -------------------------------------------------------------------
    ii() {
        echo -e "\n\t${BIwhite}󰨕 ${BIyellow}You are logged on ${BIred}$HOST"
        echo -e "\n\t${BIwhite}󰨕 ${BIyellow}Additionnal information:$NC${blue}" ; uname -a
        echo -e "\n\t${BIwhite}󰨕 ${BIyellow}Users logged on:$NC${blue}" ; w -h
        echo -e "\n\t${BIwhite}󰨕 ${BIyellow}Current date:$NC${blue}" ; date
        echo -e "\n\t${BIwhite}󰨕 ${BIyellow}Machine stats:$NC${blue}" ; uptime 
        echo -e "\n\t${BIwhite}󰨕 ${BIyellow} Current network location :$NC${blue}" ; curl ipinfo.io
        echo -e "\n${end}"
    }
