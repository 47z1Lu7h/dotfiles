...
#   -------------------------------------------------------------------
    ii() {
        echo -e "\n\t${Iyellow}You are logged on ${Icyan}$HOST"
        echo -e "\n\t${Iyellow}Additionnal information:$NC " ; uname -a
        echo -e "\n${Igreen}Users logged on:\n$NC\n" ; w -h
        echo -e "\n\t${Iyellow}Current date:$NC\n" ; date
        echo -e "\n\t${Bgreen}Machine stats:$NC" ; uptime 
        echo -e "\n\t${BIblue}Current network location :$NC  \n\t" ; curl ipinfo.io
        echo -e "\n\n"
    }
