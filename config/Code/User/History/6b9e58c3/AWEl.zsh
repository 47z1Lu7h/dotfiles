...
#   -------------------------------------------------------------------
    ii() {
        ...
        echo -e "\n\t󰨕 ${Iblue}Additionnal information:$NC " ; uname -a
        echo -e "\n\t󰨕 ${Iyellow}Users logged on:$NC" ; w -h
        echo -e "\n\t󰨕 ${Iblue}Current date:$NC" ; date
        echo -e "\n\t󰨕 ${BIyellow}Machine stats:$NC" ; uptime 
        echo -e "\n\t󰨕 ${Bblue}Current network location :$NC" ; curl ipinfo.io
        echo -e "\n${end}"
    }
