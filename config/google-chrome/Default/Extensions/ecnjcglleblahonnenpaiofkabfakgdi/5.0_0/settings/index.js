(function () {
    ...
    (function (Settings_TriggerKey) {
        ...
        Settings_TriggerKey["AltRight"] = "AltRight";
    ...
    function autoSizeTextArea(textArea) {
        ...
        textArea.style.height = "calc(".concat(textArea.scrollHeight, "px + ").concat(borderTopWidth, " + ").concat(borderBottomWidth, ")");
    }
    ...
    function loadLocalizedStrings() {
        ...
        var triggerKeyAltRightOptionLabel = document.getElementById('triggerKeyAltRightOptionLabel');
    ...
    function loadCurrentSettings() {
        chrome.storage.sync.get(defaultSettings).then(function (savedSettings) {
    ...
    function save() {
        var formValues = getFormValues();
        chrome.storage.sync.set(formValues).then(function () {
    ...
    function updateModeDescription(mode) {
        modeDescription.innerHTML = i18n.getMessage("Settings_Mode_".concat(mode, "_description"));
    }
    ...
    function updateTriggerKeyWarning(triggerKey) {
        var warningMessage = i18n.getMessage("Settings_TriggerKey_".concat(triggerKey, "_warning"));
