...
module.exports = __webpack_require__("6967");
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"0a9986ca-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/new_tab/App.vue?vue&type=template&id=026b06fc&
var Appvue_type_template_id_026b06fc_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"new-tab-screen",class:{ 'new-tab-screen_prefilled': _vm.isWaitingForPage }},[_c('Loader',{directives:[{name:"show",rawName:"v-show",value:(_vm.isSpinnerVisible),expression:"isSpinnerVisible"}],ref:"loader",staticClass:"new-tab-screen__loader",attrs:{"blocking":"","hide-scrollbar":""}}),_c('iframe',{ref:"iframe",staticClass:"new-tab-screen__iframe"})],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/new_tab/App.vue?vue&type=template&id=026b06fc&

// EXTERNAL MODULE: ./src/components/Loader.vue + 4 modules
var Loader = __webpack_require__("555f");

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/new_tab/App.vue?vue&type=script&lang=js&

var SM_MESSAGE_OPEN_URL = 'openUrl';
var SM_MESSAGE_CHECK_IFRAME_SRC = 'checkIframeSrc';
var DARK_THEME_BACKGROUND_COLOR = '#121212';
/* harmony default export */ var Appvue_type_script_lang_js_ = ({
  ...
  beforeCreate: function beforeCreate() {
    chrome.storage.local.get(['isDarkTheme', 'backgroundImage', 'backgroundColor'], function (result) {
      var backgroundContainer = document.createElement('div');
      backgroundContainer.style.position = 'fixed';
      backgroundContainer.style.zIndex = 0;
      backgroundContainer.style.top = 0;
      backgroundContainer.style.right = '16px';
      backgroundContainer.style.bottom = 0;
      backgroundContainer.style.left = 0;

      if (result.isDarkTheme) {
        document.body.classList.remove('body_no-header');
        backgroundContainer.style.backgroundImage = 'none';
        backgroundContainer.style.backgroundColor = DARK_THEME_BACKGROUND_COLOR;
      } else if (result.backgroundImage) {
        document.body.classList.add('body_no-header');
        backgroundContainer.style.backgroundImage = "url(\"".concat(result.backgroundImage, "\")");
        ...
        document.body.classList.remove('body_no-header');
        backgroundContainer.style.backgroundImage = 'none';
        backgroundContainer.style.backgroundColor = result.backgroundColor;
      }
  ...
  mounted: function mounted() {
    ...
    chrome.runtime.sendMessage({
      message: SM_MESSAGE_OPEN_URL
    }).then(function (response) {
      if (_this.$refs.iframe) {
        _this.$refs.iframe.src = response.url;
        _this.isWaitingForPage = false;
        chrome.runtime.onMessage.addListener(function (request) {
          if (request && request.message && request.message === SM_MESSAGE_CHECK_IFRAME_SRC && response.url === request.homepageUrl) {
            _this.$refs.iframe.src = request.url;
            return false;
          }
        });
      }
...
// CONCATENATED MODULE: ./src/new_tab/App.vue?vue&type=script&lang=js&
 /* harmony default export */ var new_tab_Appvue_type_script_lang_js_ = (Appvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/new_tab/App.vue?vue&type=style&index=0&lang=scss&
var Appvue_type_style_index_0_lang_scss_ = __webpack_require__("1c81");

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__("2877");

// CONCATENATED MODULE: ./src/new_tab/App.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  new_tab_Appvue_type_script_lang_js_,
  Appvue_type_template_id_026b06fc_render,
  staticRenderFns,
  false,
  null,
  null,
...
// CONCATENATED MODULE: ./src/new_tab/main.js
...
/******/ });
//# sourceMappingURL=new_tab.be8d9eaa.js.map